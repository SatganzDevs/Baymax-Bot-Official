...
exports.getCases = (cases) => {
        let data = fs.readFileSync('./satganzdevs.js', 'utf8');
        try{
    ...
    exports.getAllCmd = () => {
try {
    const jsnya = fs.readFileSync('./satganzdevs.js', 'utf8');
...
exports.didyoumean = async(input, options) => {
const results = stringSimilarity.findBestMatch(input, options);
